...
- Авто-ревок: бот периодически проверяет истекшие подписки и удаляет (ban) пользователей из `MANAGED_CHAT_IDS`
...
- `MANAGED_CHAT_IDS` - список chat_id каналов/групп через запятую, где нужно отключать доступ по истечении подписки
